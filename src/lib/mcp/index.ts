...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Ferramentas do e-Qualifica (módulos GeoConfronto e CheckTítulo). Permitem consultar análises, documentos, imóveis, comparações técnicas e achados (divergências) do usuário autenticado, além de registrar notas de revisão. Os dados são produzidos por algoritmos determinísticos; qualquer interpretação normativa é subsídio opinativo e não substitui a qualificação jurídica do Oficial.",
